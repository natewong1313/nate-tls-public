...
func (t *transferWriter) reqShouldSendContentLength() bool {
...
func (r *Request) write(w io.Writer, usingProxy bool, extraHeaders Header, waitForContinue func() bool) (err error) {
	...
	if tw.reqShouldSendContentLength() {
		r.Header.Add("SetContentLength", strconv.FormatInt(tw.ContentLength, 10))
	}
